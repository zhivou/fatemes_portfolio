...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { name: @publication.name, publisher: @publication.publisher, research_id: @publication.research_id } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { name: @publication.name, publisher: @publication.publisher, research_id: @publication.research_id } }
